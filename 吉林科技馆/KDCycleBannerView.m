...
- (void)initializePageControl {
    CGRect pageControlFrame = CGRectMake((CGRectGetWidth(_scrollView.frame) - 80)/2, CGRectGetHeight(_scrollView.frame) - 30, 80, 30);
    ...
    [_pageControl setHidden:_pageControlHidden];
